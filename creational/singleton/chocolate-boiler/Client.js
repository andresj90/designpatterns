...
const ChocolateBoiler_1 = require("./ChocolateBoiler");
const chocolateBoiler1 = ChocolateBoiler_1.ChocolateBoiler.getInstance();
const chocolateBoiler2 = ChocolateBoiler_1.ChocolateBoiler.getInstance();
